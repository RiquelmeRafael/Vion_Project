...
{
    public partial class TamanhoForm : Form
    {
        public string NomeTamanho { get; private set; } = string.Empty;
        ...
        public TamanhoForm(string? nomeAtual = null)
        {
            InitializeComponent();
            if (nomeAtual != null)
            {
                txtNome.Text = nomeAtual;
                this.Text = "Editar Tamanho";
            }
            else
            {
                this.Text = "Novo Tamanho";
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            lblNome.Size = new Size(117, 19);
            lblNome.TabIndex = 0;
            lblNome.Text = "Nome do Tamanho";
            // 
            // txtNome
            // 
