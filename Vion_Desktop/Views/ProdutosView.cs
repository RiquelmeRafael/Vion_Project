...
namespace Vion_Desktop.Views
{
    public partial class ProdutosView : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnNovo.FillColor = Color.FromArgb(0, 184, 148);
            ...
            btnEditar.FillColor = Color.FromArgb(253, 203, 110);
            ...
            btnExcluir.FillColor = Color.FromArgb(214, 48, 49);
        ...
        private void ConfigurarColunas()
        {
            ...
            string[] hiddenCols = { "Id", "ImagemUrl", "ImagemUrl2", "ImagemUrl3", "ImagemUrl4", "Descricao", "CategoriaId", "TamanhoId", "CupomId" };
